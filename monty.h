...
void nofunction(stack_t **, unsigned int);
void swap_nodes(stack_t **, unsigned int);

/*Math operations with nodes*/
void add_nodes(stack_t **, unsigned int);
void add_sub_nodes(stack_t **, unsigned int);
void add_div_nodes(stack_t **, unsigned int);
void add_mul_nodes(stack_t **, unsigned int);
void add_mod_nodes(stack_t **, unsigned int);
